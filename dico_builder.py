...
class DicoBuilder:
    ...
    def enrich_semantic_dico(self, reviews:str, previous_dico:str, nb_reviews:int):
        ...
        user_message = {
    			"role": "user",
    			"content": f"A partir des {nb_reviews} avis supplémentaires que j'ai reçu concernant mon restaurant, complète le dictionnaire sémantique existant.\n{previous_dico}. Si il n'y a pas de catégorie à rajouter n'en rajoute pas. Si tu vois des redondence, tu peux regrouper et harmoniser les catégories et sous-catégories. Je veux uniquement que tu renvoies le dictionnaire sémantique à jour. Aucun phrase de conversation ou de politesse."
				}
        reviews_message={
        	"role": "user",
          "content":reviews
